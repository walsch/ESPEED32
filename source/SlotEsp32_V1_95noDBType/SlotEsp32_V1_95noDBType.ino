...
void setup() {
  ...
  HAL_PinSetup();
  //digitalWrite(HB_IN_PIN, 1); // DEbug remove , used ot check how much from power to setup func
...
void Task2code(void *pvParameters) {
  ...
  //HalfBridge_Enable();not needed is only toggling the inhibit
  /* for(;;){
    HalfBridge_SetPwmDrag(100, 100);  // apply brake ony (and speed to 0) in case speed set is 0
    delay(1);
  }
*/
 // HalfBridge_SetPwmDrag(100, 100);  // DEBUG remove me !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
