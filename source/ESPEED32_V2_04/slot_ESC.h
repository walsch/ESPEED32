...
#define MENU_ITEMS_COUNT    8   /* Number of items in the main menu, if you add a item(E.G.parameter) in the main menu, add +1 here*/
...
#define ANTISPIN_MAX_VALUE  250   /* [ms] antispin (ANTIS) max value. */
#define FREQ_MIN_VALUE      200   /* [%]  Output PWM frequency (PWM_F) min value. */
